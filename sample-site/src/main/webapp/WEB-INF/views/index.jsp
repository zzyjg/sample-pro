...
<title>EL隐式对象[https://www.cnblogs.com/xdp-gacl/p/3938361.html]</title>
</head>
<body>
<body>
	...
	<br />
	<!-- http://localhost:8080/sample-site/index?name=aaa  -->
	${param.name}
	<!-- 此表达式会经常用在数据回显上 -->
	<form
	...
	//map{"",String[]}------------------------
	<br />
	<!-- http://localhost:8080/sample-site/index?like=aaa&like=bbb -->
	...
	<%--
      ...
      <context-param>
          ...
          <param-value>/sample-site</param-value>
      </context-param>
        --%>
